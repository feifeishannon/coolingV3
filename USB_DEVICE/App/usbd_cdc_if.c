...
{
  /* USER CODE BEGIN 10 */
    // usb_printf("cmd=%d",cmd);
  
  switch(cmd)
  {
  case CDC_SEND_ENCAPSULATED_COMMAND:
    // usb_printf("USBD_SEND_ENCAPSULATED_COMMAND");
    break;

  case CDC_GET_ENCAPSULATED_RESPONSE:
    // usb_printf("CDC_GET_ENCAPSULATED_RESPONSE");

    break;

  case CDC_SET_COMM_FEATURE:
    // usb_printf("CDC_SET_COMM_FEATURE");

    break;

  case CDC_GET_COMM_FEATURE:
    // usb_printf("CDC_GET_COMM_FEATURE");

    break;

  case CDC_CLEAR_COMM_FEATURE:
    // usb_printf("CDC_CLEAR_COMM_FEATURE");
  ...
  case CDC_SET_LINE_CODING:
    // usb_printf("CDC_SET_LINE_CODING");

    break;

  case CDC_GET_LINE_CODING:
    // usb_printf("CDC_GET_LINE_CODING");

    break;

  case CDC_SET_CONTROL_LINE_STATE:
    // usb_printf("CDC_SET_CONTROL_LINE_STATE");

    break;

  case CDC_SEND_BREAK:
    // usb_printf("CDC_SEND_BREAK");
