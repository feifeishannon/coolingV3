...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA0     ------> ADC1_INP16
    */
    GPIO_InitStruct.Pin = cool_side_CN2_Pin|GPIO_PIN_1;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA0     ------> ADC1_INP16
    */
    HAL_GPIO_DeInit(GPIOC, cool_side_CN2_Pin|GPIO_PIN_1);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PC8     ------> TIM3_CH3
    */
    GPIO_InitStruct.Pin = GPIO_PIN_6|GPIO_PIN_7|Pump_Speed_Pin;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC8     ------> TIM3_CH3
    */
    HAL_GPIO_DeInit(GPIOC, GPIO_PIN_6|GPIO_PIN_7|Pump_Speed_Pin);
